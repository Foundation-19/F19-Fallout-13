...
/obj/machinery/light/sign
	...
	icon_state = "blue"
	base_state = "blue"
	icon = 'fallout/icons/machines/64x32.dmi'
	bound_width = 64
	fitting = "bulb"
	brightness = 4
...
/obj/machinery/light/sign/kebab
	...
	icon_state = "Kebab"
	base_state = "Kebab"
	icon = 'fallout/icons/objects/structures/kebabtown.dmi'
	density = 1
	desc = "So awful..."
...
/obj/machinery/light/sign/chiken_ranch
	...
	icon = 'fallout/icons/objects/structures/chiken_ranch.dmi'
	density = 1
...
/obj/machinery/light/sign/heaven
	...
	icon = 'fallout/icons/objects/structures/heaven.dmi'
	light_color = LIGHT_COLOR_PINK
...
/obj/machinery/light/sign/crimson
	...
	icon = 'fallout/icons/objects/structures/crimson.dmi'
	brightness = 3
...
/obj/machinery/light/sign/shed
	...
	icon = 'fallout/icons/objects/structures/shed.dmi'
	brightness = 3
	light_color = LIGHT_COLOR_YELLOW
