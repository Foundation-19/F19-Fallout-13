...
//	say_mod = "rasps"
	...
	species_traits = list(HAIR,FACEHAIR, MUTCOLORS, EYECOLOR,LIPS)
	inherent_traits = list(TRAIT_RADIMMUNE, TRAIT_VIRUSIMMUNE, TRAIT_NOBREATH, TRAIT_GHOULMELEE, TRAIT_FAKEDEATH)
...
/datum/species/ghoul/on_species_gain(mob/living/carbon/C, datum/species/old_species)
	..()
	to_chat(C, "[info_text]")
	for(var/obj/item/bodypart/arm/right/b in C.bodyparts)
		b.max_damage -= 10
		b.wound_resistance = -10
	for(var/obj/item/bodypart/arm/left/b in C.bodyparts)
		b.max_damage -= 10
		b.wound_resistance = -10
	for(var/obj/item/bodypart/leg/right/b in C.bodyparts)
		b.max_damage -= 10
		b.wound_resistance = -10
	for(var/obj/item/bodypart/leg/left/b in C.bodyparts)
		b.max_damage -= 10
		b.wound_resistance = -10
