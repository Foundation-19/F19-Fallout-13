...
/obj/structure/decoration
	...
	icon = 'fallout/icons/objects/decals.dmi'
...
/obj/structure/decoration/picture/staff
	name = "staff picture"
	desc = "A framed picture with a bunch of scientists on it, you presume these were the people running the place."
	icon_state = "photo_staff"

/obj/structure/decoration/picture/moon
	name = "moon picture"
	desc = "A framed picture with three astronauts on it, behind them is a picture of the Moon, guess someone made it up there afterall huh?"
	icon_state = "photo_moon"

/obj/structure/decoration/picture/family
	name = "family picture"
	desc = "A framed picture with a man, a woman and a small baby, wonder if they're still alive."
	icon_state = "photo_family"
