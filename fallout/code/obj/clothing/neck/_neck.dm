...
/obj/item/clothing/neck/stethoscope/attack(mob/living/carbon/human/M, mob/living/user)
	if(ishuman(M) && isliving(user))
		if(user.a_intent == INTENT_HELP)
			...
			if(M.stat == DEAD && heart && world.time - M.timeofdeath < CONFIG_GET(number/death_revive_time) MINUTES * 10)
...
/obj/item/clothing/neck/scarf/cptpatriot
	...
	greyscale_colors = "cptpatriotscarf"
...
/obj/item/clothing/neck/corditeclamp
	...
	greyscale_colors = "corditeclamps"
