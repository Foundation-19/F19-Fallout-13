...
/obj/item/clothing/under/proc/attach_accessory(obj/item/I, mob/user, notifyAttach = 1)
	...
	if(istype(I, /obj/item/clothing/accessory))
		...
		if(dummy_thick)
			...
			if(A.worn_icon) // Sunset Wasteland changes: should make modularized accessories work on-mob.
				accessory_overlay = mutable_appearance(A.worn_icon, attached_accessory.icon_state) // Ditto
