...
/datum/reagent/consumable/ethanol/tatovodka
	...
	name = "glass of tato vodka"
	description = "The glass contains actual swill tato vodka."
...
/datum/reagent/consumable/ethanol/buffalo
	...
	glass_icon_state = "glass_brown"
	name = "glass of fermented buffalo juice"
	description = "The fermented liquid of the buffalo gourd. Very bitter."
...
/datum/reagent/consumable/ethanol/pungajuice
	...
	name = "glass of punga juice"
	description = "The glass contain punga juice, used to treat radiation sickness"
...
/datum/reagent/consumable/ethanol/salgam
	...
	name = "şalgam"
	description = "A powerful spirit brewed from the xander root."
...
/datum/reagent/consumable/ethanol/nukabomb/on_mob_delete(mob/living/M)
	M.playsound_local(M, 'fallout/sound/f13effects/explosion_2.ogg', 100, 0)
	M.Knockdown(10, 0)
	..()
...
/datum/reagent/consumable/ethanol/vimcap
	...
	name = "Vim Captains Blend"
	description = "A glass of special vim holding the taste of the sea, Far from here."
...
/datum/reagent/consumable/ethanol/bbock
	...
	name = "Ballistic Bock"
	description = "An explosive cocktail that probably shouldn' be ingested. Fills you with <BIG>BALLISTIC RAGE<BIG>."
	var/datum/brain_trauma/special/psychotic_brawling/bath_salts/rage
...
/datum/reagent/consumable/ethanol/jakejuice
	...
	name = "Jake Juice"
	description = "Patented Jake Juice, Mixable at users own legal discretion."
...
/datum/reagent/consumable/ethanol/wastetequila
	...
	name = "Wasteland Tequila"
	description = "Brewed and distributed through the illusive Rad-Hombres."
...
/datum/reagent/consumable/ethanol/oldpossum
	...
	name = "Old Possum"
	description = "A ratmans classic, chalky and privelaged."
...
/datum/reagent/consumable/ethanol/atombomb/on_mob_life(mob/living/carbon/M)
	...
	if(prob(50))
		to_chat(M, span_notice("[high_message]"))
	if(prob(50))
		M.playsound_local(M, 'fallout/sound/f13effects/explosion_fire.ogg', 100, 0)
	if(prob(50))
		M.playsound_local(M, 'fallout/sound/f13effects/alarm.ogg', 100, 0)
...
/datum/reagent/consumable/ethanol/fernet_cola
	...
	description = "A sawed-off cola bottle filled with Fernet Cola. Nothing better after eating like a lardass."
...
/datum/reagent/consumable/ethanol/spiritcleanser/on_mob_add(mob/living/M) //spiritual shizzle, also admemes getting booled on
	ADD_TRAIT(M, TRAIT_SPIRITUAL, "[type]")
	if(prob(50))
		M.playsound_local(M, 'fallout/sound/f13ambience/bird_6.ogg', 100, 0)
	if(prob(50))
