...
/mob/living/simple_animal/hostile/renegade
	...
	icon = 'fallout/code/modular_sunset/icons/mob/renegades/renegade.dmi'
	...
	attack_fallout/sound = 'sound/weapons/smash.ogg'
...
/mob/living/simple_animal/hostile/renegade/defender
	...
	projectile_sound_properties = list(
		...
		SP_NORMAL_RANGE_SILENCED(SILENCED_GUN_RANGE),
		SP_IGNORE_WALLS(TRUE),
		SP_DISTANT_fallout/sound(RIFLE_MEDIUM_DISTANT_fallout/sound),
...
/mob/living/simple_animal/hostile/renegade/drifter
	...
	projectile_sound_properties = list(
		...
		SP_NORMAL_RANGE_SILENCED(SILENCED_GUN_RANGE),
		SP_IGNORE_WALLS(TRUE),
		SP_DISTANT_fallout/sound(SHOTGUN_DISTANT_fallout/sound),
		SP_DISTANT_RANGE(SHOTGUN_RANGE_DISTANT)
	)
...
/mob/living/simple_animal/hostile/renegade/meister
	...
	projectile_sound_properties = list(
		...
		SP_NORMAL_RANGE_SILENCED(SILENCED_GUN_RANGE),
		SP_IGNORE_WALLS(TRUE),
		SP_DISTANT_fallout/sound(RIFLE_LIGHT_DISTANT_fallout/sound),
...
/mob/living/simple_animal/hostile/renegade/doc
	...
	projectile_sound_properties = list(
		...
		SP_NORMAL_RANGE_SILENCED(SILENCED_GUN_RANGE),
		SP_IGNORE_WALLS(TRUE),
		SP_DISTANT_fallout/sound(PISTOL_HEAVY_DISTANT_fallout/sound),
