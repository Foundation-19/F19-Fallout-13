...
Just leaving this here for quick copy-pasting, for future contributors.
	...
	worn_icon = 'modular_sunset/icons/mob/clothing/mask.dmi'
...
/obj/item/clothing/mask/gas/goner
	...
	icon = 'fallout/code/modular_sunset/icons/obj/clothing/masks.dmi'
	worn_icon = 'fallout/code/modular_sunset/icons/mob/clothing/mask.dmi'
