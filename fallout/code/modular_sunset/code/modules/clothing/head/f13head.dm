...
Just leaving this here for quick copy-pasting, for future contributors.
	...
	worn_icon = 'modular_sunset/icons/mob/clothing/head.dmi'
...
/obj/item/clothing/head/helmet/f13/goner
	...
	icon = 'fallout/code/modular_sunset/icons/obj/clothing/hats.dmi'
	worn_icon = 'fallout/code/modular_sunset/icons/mob/clothing/head.dmi'
