...
Just leaving this here for quick copy-pasting, for future contributors.
	...
	worn_icon = 'modular_sunset/icons/mob/clothing/uniform.dmi'
...
/obj/item/clothing/under/f13/goner
	...
	icon = 'fallout/code/modular_sunset/icons/obj/clothing/uniforms.dmi'
	worn_icon = 'fallout/code/modular_sunset/icons/mob/clothing/uniform.dmi'
