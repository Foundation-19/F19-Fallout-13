...
/obj/item/clothing/glasses/night/polarizing // possibly it would be better to make this just flash protect or such, and keep NVG to NVG looking goggle thingies. Dunno.
	...
	inhand_icon_state = "goggles_polarizing"
	darkness_view = 12
...
/obj/item/clothing/neck/mantle/legion
	...
	inhand_icon_state = "mantle_legion"
	layer = NECK_LAYER
...
/obj/item/storage/backpack/marching_satchel
	...
	inhand_icon_state = "satchel_marching"
...
/obj/item/storage/belt/holster/rugged	// some sort of overlay system for the filled holsters would be better naturally but lack the time to figure it out.
	...
	inhand_icon_state = "holster_rugged"
...
/obj/item/storage/belt/utility/waster
	...
	inhand_icon_state = "belt_blacksmith"
...
/obj/item/clothing/suit/armor/heavy/metal/smithed/legion
	...
	inhand_icon_state = "armor_smithed"
...
/obj/machinery/radioterminal/legion/wallmounted
	...
	icon = 'fallout/code/modular_atom/legio_invicta/icons/icons_64x32_legion.dmi'
...
/obj/structure/chair/comfy/bathtub/GetArmrest()
	return mutable_appearance('fallout/code/modular_atom/legio_invicta/icons/icons_legion.dmi', "bathtub_bathing")
...
/obj/structure/chair/comfy/bathtub/post_buckle_mob(mob/living/M)
	...
	handle_layer()
	playsound(src, 'fallout/code/modular_atom/blacksmith/sound/water_splash2.ogg',50, 1)
...
/obj/structure/statue/mars
	...
	icon = 'fallout/code/modular_atom/legio_invicta/icons/64x64_icons.dmi'
...
/obj/structure/railing/handrail/legion/entrance/on_attack_hand(mob/user, act_intent = user.a_intent, unarmed_attack_flags)
	...
	if(!do_after(user, 20, TRUE, src))
		...
		playsound(get_turf(src), 'fallout/code/modular_atom/sound/doorchainsoft_open.ogg', 60, TRUE)
		if(density)
...
added this to make the overlay actually work
			var/mutable_appearance/filling_overlay = mutable_appearance('fallout/code/modular_atom/icons/primitive_medical.dmi', "reagent")
*/
...
/turf/open/floor/plating/f13/outside/roof/tent_leather
	...
	icon = 'fallout/icons/turfs/walls/tents.dmi'
	icon_state = "leather_roof"

// shading under the pavillon
/obj/effect/turf_decal/shadow
	icon = 'fallout/code/fallout/code/modular_atom/legio_invicta/icons/icons_legion.dmi'
	icon_state = "shadow"
...
/obj/structure/simple_door/metal/barred/left
	icon = 'fallout/code/modular_atom/icons/door_barred.dmi'
	icon_state = "barred_left"
	door_type = "barred_left"
	open_sound = 'fallout/code/fallout/code/modular_atom/sound/doorchainsoft_open.ogg'
	close_sound = 'fallout/code/fallout/code/modular_atom/sound/doorchainsoft_close.ogg'
...
/obj/effect/turf_decal/gravel_edge
	icon = 'fallout/code/turfs/gravel.dmi'
...
/obj/effect/overlay/desert/sonora/edge
	icon = 'fallout/code/fallout/code/modular_atom/icons/tileset_sonora.dmi'
