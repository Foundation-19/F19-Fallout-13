...
/obj/structure/blacksmith/quenching/attackby(obj/item/I, mob/user)
	if(istype(I, /obj/item/smithing))
		...
		playsound(src, 'fallout/code/modular_atom/blacksmith/sound/steam_whoosh.ogg', 40, TRUE)
...
/obj/structure/blacksmith/quenching/attackby(obj/item/I, mob/user)
	if(istype(I, /obj/item/blacksmith/ingot))
		...
		playsound(src, 'fallout/code/modular_atom/blacksmith/sound/steam_short.ogg',70, 1)
		flick("quench_boil",src)
		var/datum/effect_system/steam_spread/puff = new /datum/effect_system/steam_spread/()
		puff.effect_type = /obj/effect/particle_effect/steam
		puff.set_up(1, 0, src)
...
/obj/item/clothing/gloves/blacksmith_mittens
	...
	inhand_icon_state = "blacksmith_mittens"
...
/obj/item/clothing/gloves/blacksmith_mittens/equipped(mob/user, slot)
	. = ..()
	if(ishuman(user) && user.mind && slot == HANDS)
...
/obj/machinery/workbench/forge // should be repathed to worbench/metal
	...
	icon = 'fallout/code/modular_atom/blacksmith/icons/workbench64x32.dmi'
...
/obj/item/stack/ore/coal // turns to coke when heated in a Furnace or ORM
	...
	icon = 'fallout/code/modular_atom/icons/stackable_items.dmi'
	icon_state = "ore_coal"
