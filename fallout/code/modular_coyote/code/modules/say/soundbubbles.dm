...
GLOBAL_LIST_INIT(typing_indicator_sounds, list(
		"Default"	= 'fallout/code/modular_coyote/sound/typing/default.ogg',
		"Deep"	= 'fallout/code/modular_coyote/sound/typing/deepspeak.ogg',
		"Soft"	= 'fallout/code/modular_coyote/sound/typing/softspeak.ogg',
		"Light"	= 'fallout/code/modular_coyote/sound/typing/lightspeak.ogg',
		"Fatass" = 'fallout/code/modular_coyote/sound/typing/arfs1sounds/boar1.ogg',
		"Deranged" = 'fallout/code/modular_coyote/sound/typing/arfs1sounds/pug1.ogg',
				))

//lmfao at lizard ~TK420634

/datum/looping_sound/typing_indicator
	mid_sounds = list('fallout/code/modular_coyote/sound/typing/default.ogg')
	mid_length = 30
	volume = 10
...
/datum/preferences
	var/list/features_speech = list("typing_indicator_sound" = 'fallout/code/modular_coyote/sound/typing/default.ogg', "typing_indicator_sound_play" = "No Sound")
/* // Disabled for now
/mob
...
/mob/proc/get_typing_indicator_sound()
	...
	return 'fallout/code/modular_coyote/sound/typing/default.ogg'
