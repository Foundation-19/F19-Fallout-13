...
/obj/projectile/bullet/c22/shock/on_hit(atom/target, blocked = FALSE)
	..()
...
/obj/projectile/bullet/c9mm/improvised
 ...
 * WNAKED: 7.5
 */
/obj/projectile/bullet/c9mm/acid
...
/obj/projectile/bullet/c9mm/acid/Initialize()
	. = ..()
	create_reagents(2.5, NO_REACT, NO_REAGENTS_VALUE)
	reagents.add_reagent(acid_type, 2.5)

/obj/projectile/bullet/c9mm/acid/on_hit(atom/target, blocked = FALSE)
	. = ..()
	if(isliving(target))
 ...
 * WNAKED: 0
 */
/obj/projectile/bullet/c9mm/incendiary
...
/obj/projectile/bullet/c9mm/incendiary/on_hit(atom/target, blocked = FALSE)
	. = ..()
	if(iscarbon(target))
 ...
 * WNAKED: 3.75
 */
/obj/projectile/bullet/c9mm/op //for simple mobs, separate to allow balancing
	name = "9mm +P bullet"
 ...
 * WNAKED: 3.75
 */
/obj/projectile/bullet/c9mm/simple //also for simple mobs, separate to allow balancing
	name = "9mm bullet"
	damage = BULLET_DAMAGE_PISTOL_LIGHT * BULLET_SURPLUS_MULT
	stamina = BULLET_STAMINA_PISTOL_LIGHT * BULLET_SURPLUS_MULT
	spread = BULLET_SPREAD_SURPLUS
...
/obj/projectile/bullet/c38/improvised
...
/obj/projectile/bullet/c38/acid
...
/obj/projectile/bullet/c38/acid/Initialize()
	. = ..()
	create_reagents(5, NO_REACT, NO_REAGENTS_VALUE)
	reagents.add_reagent(acid_type, 5)

/obj/projectile/bullet/c38/acid/on_hit(atom/target, blocked = FALSE)
	..()
	if(isliving(target))
		var/mob/living/M = target
		reagents.reaction(M, TOUCH)
...
/obj/projectile/bullet/c38/incendiary
...
/obj/projectile/bullet/c38/incendiary/on_hit(atom/target, blocked = FALSE)
	. = ..()
	if(iscarbon(target))
		var/mob/living/carbon/M = target
		M.adjust_fire_stacks(fire_stacks)
 ...
 * WNAKED: 3.75
 */
/obj/projectile/bullet/needle //strictly better than HN cartridges, but cannot be produced ever
	name = "HN AP dart"
	icon_state = "cbbolt"
	damage = BULLET_DAMAGE_PISTOL_LIGHT * BULLET_MATCH_MULT
...
/obj/projectile/bullet/needle/improvised
	name = "HN dart"
	icon_state = "cbbolt"
	damage = BULLET_DAMAGE_PISTOL_LIGHT * BULLET_HANDLOAD_MULT
 ...
 * WNAKED: 3.75
 */
/obj/projectile/bullet/c10mm/improvised
 ...
 * WNAKED: 0
 */
/obj/projectile/bullet/c10mm/incendiary
...
/obj/projectile/bullet/c10mm/incendiary/on_hit(atom/target, blocked = FALSE)
	. = ..()
	if(iscarbon(target))
		var/mob/living/carbon/M = target
		if(M.fire_stacks < 1)
 ...
 * WNAKED: 5
 */
/obj/projectile/bullet/c45/improvised
 ...
 * WNAKED: 5
 */
/obj/projectile/bullet/c45/simple
	name = ".45 FMJ bullet"
	damage = BULLET_DAMAGE_PISTOL_MEDIUM * BULLET_HANDLOAD_MULT * BULLET_45ACP_DAMAGE_MULT
	stamina = BULLET_STAMINA_PISTOL_MEDIUM * BULLET_HANDLOAD_MULT * BULLET_45ACP_STAMINA_MULT
	spread = BULLET_SPREAD_SURPLUS
 ...
 * WNAKED: 7.5
 */
/obj/projectile/bullet/a357/improvised
 ...
 * WNAKED: 15
 */
/obj/projectile/bullet/a357/acid
...
/obj/projectile/bullet/a357/acid/Initialize()
	. = ..()
	create_reagents(5, NO_REACT, NO_REAGENTS_VALUE)
	reagents.add_reagent(acid_type, 5)

/obj/projectile/bullet/a357/acid/on_hit(atom/target, blocked = FALSE)
	. = ..()
	if(isliving(target))
		var/mob/living/M = target
		reagents.reaction(M, TOUCH)
 ...
 * WNAKED: 15
 */
/obj/projectile/bullet/m44/improvised
 ...
 * WNAKED: 15
 */
/obj/projectile/bullet/mm14/improvised
 ...
 * WNAKED: 0
 */
/obj/projectile/bullet/mm14/contam
...
/obj/projectile/bullet/mm14/contam/Initialize()
	. = ..()
	create_reagents(15, NO_REACT, NO_REAGENTS_VALUE)
	reagents.add_reagent(/datum/reagent/toxin/metabtoxin, 15)

/obj/projectile/bullet/mm14/contam/on_hit(atom/target, blocked = FALSE)
	. = ..()
 ...
 * WNAKED: 7.5
 */
/obj/projectile/bullet/a45lc/improvised
...
/// Sharp fuckin rock
/obj/projectile/bullet/ghoul_rock
	name = "sharp rock"
...
/// Rock, but smoove
/obj/projectile/bullet/ghoul_rock/blunt_rock
	name = "heavy rock"
	sharpness = SHARP_NONE

/// Embeds, but they rarely throw them
/obj/projectile/bullet/ghoul_rock/jagged_scrap
...
/obj/projectile/bullet/needle/Initialize()
	. = ..()
	create_reagents(50, NO_REACT, NO_REAGENTS_VALUE)

/obj/projectile/bullet/needle/on_hit(atom/target, blocked = FALSE, skip = FALSE)
	if(iscarbon(target))
		var/mob/living/carbon/M = target
