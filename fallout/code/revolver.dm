...
/obj/item/gun/ballistic/revolver
	...
	equipsound = 'fallout/sound/f13weapons/equipsounds/pistolequip.ogg'
...
/obj/item/gun/ballistic/revolver/verb/spin()
	...
	if(do_spin())
		...
		playsound(src, 'fallout/sound/f13weapons/revolverspin.ogg', 30, 1)
	else
		verbs -= /obj/item/gun/ballistic/revolver/verb/spin
...
/obj/item/gun/ballistic/revolver/revolver45
	...
	draw_time = GUN_DRAW_QUICK
	damage_multiplier = GUN_EXTRA_DAMAGE_0
	fire_sound = 'fallout/sound/f13weapons/45revolver.ogg'
...
/obj/item/gun/ballistic/revolver/colt357
	...
	fire_sound = 'fallout/sound/f13weapons/357magnum.ogg'
	gun_sound_properties = list(
		SP_VARY(FALSE),
		SP_VOLUME(PISTOL_MEDIUM_VOLUME),
		SP_VOLUME_SILENCED(PISTOL_MEDIUM_VOLUME * SILENCED_VOLUME_MULTIPLIER),
...
/obj/item/gun/ballistic/revolver/revolver44
	...
	fire_sound = 'fallout/sound/f13weapons/44revolver.ogg'
	gun_sound_properties = list(
		SP_VARY(FALSE),
		SP_VOLUME(PISTOL_HEAVY_VOLUME),
		SP_VOLUME_SILENCED(PISTOL_HEAVY_VOLUME * SILENCED_VOLUME_MULTIPLIER),
...
/obj/item/gun/ballistic/revolver/needler
	...
	silenced = TRUE
	fire_sound = 'fallout/sound/weapons/gunshot_silenced.ogg'
	fire_sound_silenced = 'fallout/sound/weapons/gunshot_silenced.ogg'
