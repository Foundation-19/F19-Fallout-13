...
/datum/mood_event/hydration/full
	description = "<span class='warning'><B>Drank way too much water</B></span>\n" //muh fatshaming
	mood_change = -8

/datum/mood_event/hydration/med
	description = "<span class='nicegreen'>I feel great and hydrated</span>\n"
	mood_change = 6

/datum/mood_event/hydration/low_med
	description = "<span class='nicegreen'>Im getting thirsty</span>\n"
	mood_change = 3

/datum/mood_event/hydration/low
	description = "<span class='warning'>Im so thirsty</span>\n"
	mood_change = -8

/datum/mood_event/hydration/very_low
	description = "<span class='boldwarning'>Please, waterrrrrrrrrrrr</span>\n"
	mood_change = -15
