...
GLOBAL_LIST_INIT(snow_recipes, list ( \
	new/datum/stack_recipe("Snow Wall", /turf/closed/wall/mineral/snow, 15, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("Snowman", /obj/structure/statue/snow/snowman, 15, one_per_turf = 1, on_floor = 1), \
