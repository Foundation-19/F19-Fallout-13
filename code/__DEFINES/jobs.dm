...
#define F13RIOSHERIFF		(1<<0)
#define F13RIODOC       (1<<1)
#define F13RIOSETTLER		(1<<2)
#define F13RIOFARMER		(1<<3)
#define F13RIOPROSPECTOR	(1<<4)
#define F13RIODEPUTY		(1<<5)
#define F13RIOMAYOR		(1<<6)
#define F13RIOPREACHER		(1<<7)
#define F13RIOSHOPKEEPER	(1<<8)
#define F13RIOFAITHFUL		(1<<9) // WHAT IS BITFLAG. WHAT DOES IT DO. WHERE IS THIS INFO USED.
#define F13RIOBANKER		(1<<10)	// IDK MAN BUT IT SEEMS IMPORTANT
#define F13RIOBARKEEP		(1<<11)
