...
/obj/item/reagent_containers/syringe/lethal/blackpowder
	...
	desc = "Syringe with 100 gunpowder units. Stick it in and set it on fire."
...
/obj/item/reagent_containers/syringe/lethal/blackpowder/pizdec
	name = "Black Powder injection syringe"
	desc = "Syringe with 1000 gunpowder units. Stick it in and set it on fire. Don't forget to hide."
