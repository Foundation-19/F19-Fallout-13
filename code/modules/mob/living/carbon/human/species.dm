...
/datum/species/proc/handle_hair(mob/living/carbon/human/H, forced_colour)
	...
	if(H.facial_hair_style && (FACEHAIR in species_traits) && (!facialhair_hidden || dynamic_fhair_suffix))
		...
		if(S)
			...
			if(!fextensions)
				var/icon/fhair_extensions = icon('fallout/code/modular_atom/fashion/icons/facial_hair_extensions.dmi')
//				var/icon/fhair_extensions = icon('icons/mob/facialhair_extensions.dmi') commented out since above needed for fashion module extensions
			...
			if(fextensions[fhair_state+dynamic_fhair_suffix])
				...
				fhair_file = 'fallout/code/modular_atom/fashion/icons/facial_hair_extensions.dmi'
//				fhair_file = 'icons/mob/facialhair_extensions.dmi'	 commented out since above needed for fashion module extensions
	...
	if(!hair_hidden || dynamic_hair_suffix)
		...
		if(!hair_hidden && !H.getorgan(/obj/item/organ/internal/brain)) //Applies the debrained overlay if there is no brain
			if(!(NOBLOOD in species_traits))
				hair_overlay.icon = 'fallout/icons/mob/hair.dmi'
			...
			if(S)
				...
				if(!extensions)
					var/icon/hair_extensions = icon('fallout/code/modular_atom/fashion/icons/hair_extensions.dmi')
//					var/icon/hair_extensions = icon('icons/mob/hair_extensions.dmi')	commented out since above needed for fashion module extensions
				...
				if(extensions[hair_state+dynamic_hair_suffix])
					...
					hair_file = 'fallout/code/modular_atom/fashion/icons/hair_extensions.dmi'
//					hair_file = 'icons/mob/hair_extensions.dmi'	commented out since above needed for fashion module extensions
				...
				if(grad_style_ref)
					grad_s = new/icon("icon" = 'fallout/code/modular_coyote/icons/mob/hair_gradients.dmi', "icon_state" = grad_style_ref)
