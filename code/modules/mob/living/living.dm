...
/mob/living/proc/mob_sleep()
	...
	if(IsSleeping())
		to_chat(src, "<span class='notice'>You are already asleep.</span>")
		return
	else
		if(alert(src, "Are you sure you want to sleep?", "Sleep", "Yes", "No") == "Yes")
...
/mob/living/proc/lay_down()
	...
	if(!under_object)
		...
		to_chat(src, "<span class='danger'>When you tried to get up, you hit [under_object] with your head!<br>Ouch!</span>")
