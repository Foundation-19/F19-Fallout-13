...
/obj/item/clothing/suit/f13/mfp/johnjacket
	name = "bomber vest"
	desc = "What used to be a heavy winter bomber jacket, albeit the fur has weathered from gray to yellow and it's sleeves have been purposely removed. It also appears to have been shortened."
	icon_state = "johnjacket"
