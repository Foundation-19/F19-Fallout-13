...
/datum/job/rio/riomayor
	...
	outfit = /datum/outfit/job/rio/riomayor
...
/datum/outfit/job/den/riomayor/pre_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
	H.add_trait(TRAIT_TECHNOPHREAK, TRAIT_GENERIC)

/datum/outfit/job/rio/riomayor
	name = "Mayor"
	jobtype = /datum/job/rio/riomayor
...
/datum/job/rio/riosheriff
	...
	outfit = /datum/outfit/job/rio/riosheriff

	access = list(ACCESS_TOWN_COMMAND, ACCESS_BAR, ACCESS_CLONING, ACCESS_GATEWAY, ACCESS_CARGO_BOT, ACCESS_MINT_VAULT, ACCESS_KITCHEN, ACCESS_MINING, ACCESS_FORENSICS_LOCKERS)
	minimal_access = list(ACCESS_BAR, ACCESS_CLONING, ACCESS_GATEWAY, ACCESS_CARGO_BOT, ACCESS_MINT_VAULT, ACCESS_KITCHEN, ACCESS_MINING, ACCESS_FORENSICS_LOCKERS)

/datum/outfit/job/rio/riosheriff
	name = "Sheriff"
	jobtype = /datum/job/rio/riosheriff
...
/datum/job/rio/riosheriff/after_spawn(mob/living/carbon/human/H, mob/M)
...
/datum/job/rio/riodeputy
	...
	department_head = list("Mayor")
	outfit = /datum/outfit/job/rio/riodeputy
	access = list(ACCESS_BAR, ACCESS_GATEWAY)
	minimal_access = list(ACCESS_BAR, ACCESS_GATEWAY)

/datum/outfit/job/rio/riodeputy
	name = "Deputy"
	jobtype = /datum/job/rio/riodeputy
...
/datum/job/rio/riofarmer
	...
	outfit = /datum/outfit/job/rio/riofarmer
	department_head = list("Mayor")
	access = list(ACCESS_BAR,  ACCESS_KITCHEN)
	minimal_access = list(ACCESS_BAR,  ACCESS_KITCHEN)

/datum/outfit/job/rio/riofarmer
	name = "Farmer"
	jobtype = /datum/job/rio/riofarmer
...
/datum/outfit/job/rio/riosettler/pre_equip(mob/living/carbon/human/H)
	..()
	uniform = pick(
...
/datum/job/rio/rioprospector
	title = "Prospector"
	flag = F13RIOPROSPECTOR
	department_flag = RIO
	faction = "RGR"
	total_positions = 4
	spawn_positions = 4
	...
	exp_type = EXP_TYPE_CREW
	department_head = list("Mayor")
	outfit = /datum/outfit/job/rio/rioprospector

	access = list(ACCESS_BAR, ACCESS_MINING)
	minimal_access = list(ACCESS_BAR, ACCESS_MINING)

/datum/outfit/job/rio/rioprospector
	name = "Prospector"
	jobtype = /datum/job/rio/rioprospector
...
/datum/outfit/job/rio/rioprospector/pre_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
	H.add_trait(TRAIT_TECHNOPHREAK, TRAIT_GENERIC)
...
/datum/job/rio/riodendoc
	...
	exp_type = EXP_TYPE_CREW
	department_head = list("Mayor")
	outfit = /datum/outfit/job/rio/riodendoc
	access = list(ACCESS_BAR, ACCESS_CLONING)
	minimal_access = list(ACCESS_BAR, ACCESS_CLONING)

/datum/outfit/job/rio/riodendoc
	name = "Doctor"
	jobtype = /datum/job/rio/riodendoc
	chemwhiz = TRUE
...
/datum/job/rio/riopreacher
	...
	exp_type = EXP_TYPE_CREW
	department_head = list("Mayor")
	outfit = /datum/outfit/job/rio/riopreacher
...
/datum/job/rio/riopreacher/after_spawn(mob/living/H, mob/M)
	if(H.mind)
		H.mind.isholy = TRUE
...
/datum/outfit/job/rio/riopreacher
	name = "Preacher"
	jobtype = /datum/job/rio/riopreacher
	ears = /obj/item/radio/headset/headset_den
	belt = null
...
/datum/job/rio/riobarkeep
	...
	department_head = list("Mayor")
	outfit = /datum/outfit/job/rio/riobarkeep
...
/datum/outfit/job/rio/riobarkeep
	name = "Barkeep"
	jobtype = /datum/job/rio/riobarkeep
...
/datum/job/rio/riosettler
	...
	department_head = list("Mayor")
	outfit = /datum/outfit/job/rio/riosettler
...
/datum/outfit/job/rio/riosettler
	name = "Citizen"
	jobtype = /datum/job/rio/riosettler
	ears = /obj/item/radio/headset/headset_den
	belt = null
	id = /obj/item/card/id/dogtag/town
	ears = /obj/item/radio/headset/headset_den
...
/datum/job/rio/riobanker
	...
	outfit = /datum/outfit/job/rio/riobanker
...
/datum/outfit/job/rio/riobanker
	name = "Banker"
	jobtype = /datum/job/rio/riobanker
...
/datum/job/rio/rioshopkeeper
    title = "Shopkeeper"
    flag = F13RIOSHOPKEEPER
    department_flag = RIO
    faction = "RGR"
    total_positions = 2
    spawn_positions = 2
    ...
    outfit = /datum/outfit/job/rio/rioshopkeeper
    access = list(ACCESS_BAR, ACCESS_CARGO_BOT)
    minimal_access = list(ACCESS_BAR, ACCESS_CARGO_BOT)

/datum/outfit/job/rio/rioshopkeeper
    name = "Shopkeeper"
    jobtype = /datum/job/rio/rioshopkeeper
...
/datum/outfit/job/rio/rioshopkeeper/pre_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
	H.add_trait(TRAIT_TECHNOPHREAK, TRAIT_GENERIC)

/datum/job/rio/rioshopkeeper/after_spawn(mob/living/carbon/human/H, mob/M)
