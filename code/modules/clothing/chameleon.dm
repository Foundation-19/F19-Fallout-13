...
/datum/action/chameleon_outfit/proc/initialize_outfits()
	...
	if(!standard_outfit_options)
		...
		var/outfits = subtypesof(/datum/outfit/job/bos) + subtypesof(/datum/outfit/job/den) + subtypesof(/datum/outfit/job/enclave) + subtypesof(/datum/outfit/job/followers) + subtypesof(/datum/outfit/job/CaesarsLegion) + subtypesof(/datum/outfit/job/ncr) + subtypesof(/datum/outfit/job/vault) + subtypesof(/datum/outfit/job/wasteland)
