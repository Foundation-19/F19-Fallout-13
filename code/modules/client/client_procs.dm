	...
	//SECURITY//
	////////////
#define UPLOAD_LIMIT		12000000//5242880	//Restricts client uploads to the server to 5MB //Could probably do with being lower.
...
/client/proc/set_client_age_from_db(connectiontopic)
	...
	if(!query_client_in_db.NextRow())
		if (CONFIG_GET(flag/panic_bunker) && !holder && !GLOB.deadmins[ckey] && !(ckey in GLOB.bunker_passthrough))
			...
			to_chat(src, "You must be whitelisted to connect to Desert Rose. Please apply on our Discord: https://discord.gg/NGpP36ms.")
